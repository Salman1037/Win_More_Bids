                                ...
                                <div className="row al-center">
                                    <div className="col-lg-8 lg-t-center lg-mb-25">
                                        <div className="footer__one-cta-title title_split_anim">
                                                        <h2>Win More Bids — Request a Free Sample Takeoff</h2>
                                                    </div>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-sm-6">
                                        <div className="footer__one-widget mr-40">
                                            <Link className="logo" to="/"><img src={logo} alt="Win Bids Co logo" /></Link>
                                            <h5>Precision Cost Estimates & Material Takeoffs — Serving the USA</h5>
                                        </div>
                                    </div>
