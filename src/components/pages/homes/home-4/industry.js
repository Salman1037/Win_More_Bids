                ...
                <div className="row al-center">
                    ...
                    <div className="col-lg-6">
                        <div className="industry__four-right ml-45 xl-ml-0">
                            <span className="subtitle wow fadeInLeft" data-wow-delay=".4s">Sectors & Certifications</span>
                            <h2 className="mb-20 wow fadeInRight" data-wow-delay=".6s">Serving Contractors, Developers & Architects</h2>
                            <p className="wow fadeInUp" data-wow-delay=".4s">We deliver sector-specific takeoffs and certified estimating workflows across residential, commercial and civil projects — with regional pricing where required.</p>
