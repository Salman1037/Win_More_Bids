                    ...
                    <div className="row mb-30">
                        <div className="col-xl-12">
                            <div className="blog__four-title t-center">
                                <span className="subtitle wow fadeInLeft" data-wow-delay=".4s">Insights</span>
                                <h2 className="wow fadeInRight" data-wow-delay=".6s">Estimating News & Case Studies</h2>
                            </div>					
                        </div>
                    </div>
                    <div className="row">
