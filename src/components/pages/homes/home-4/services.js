                ...
                <div className="row">
                    <div className="col-xl-5 col-lg-6 lg-mb-25">
                        <div className="services__four-title section-padding pb-0">
                            <span className="subtitle wow fadeInLeft" data-wow-delay=".4s">Estimating Services</span>
                            <h2 className="wow fadeInRight" data-wow-delay=".6s">Accurate Takeoffs & Cost Estimates</h2>
                            <p className="wow fadeInUp" data-wow-delay=".4s">Digital takeoffs, RSMeans benchmarking and auditable cost summaries that help contractors submit competitive, profitable bids.</p>
                            <div className="wow fadeInDown" data-wow-delay="1.2s">
                                <Link className="build_button mt-40"  to="/services">Explore Services<i className="flaticon-right-up"></i></Link>
                            </div>
                        </div>
                    </div>            
