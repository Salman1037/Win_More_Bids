                ...
                <div className="row al-center">
                    ...
                    <div className="col-lg-9">
                        <div className="about__four-title">
                            ...
                            <h2 className="mb-20 wow fadeInRight" data-wow-delay=".6s">Helping Contractors Win Profitable Bids</h2>
                            <p className="wow fadeInUp" data-wow-delay=".4s">Win Bids Co delivers fast, accurate cost estimates and material takeoffs so contractors, builders and developers can submit competitive, profitable bids.</p>
                            <div className="wow fadeInDown" data-wow-delay="1.2s">
                                <Link className="build_button mt-25" to="/request-quote">Request a Quote<i className="flaticon-right-up"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
