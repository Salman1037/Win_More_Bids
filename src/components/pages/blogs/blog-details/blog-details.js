                ...
                <div className="row">
                    <div className="col-lg-8 lg-mb-25">
                        <div className="blog__details-area">
                            ...
                            {singleData.longContent && singleData.longContent.map((para, idx) => (
                                <p key={idx}>{para}</p>
                            ))}
                            ...
                            {singleData.sections && singleData.sections.map((section, sidx) => (
                                <div key={sidx}>
                                    <h4 className="mb-20">{section.heading}</h4>
                                    <p>{section.content}</p>
                                </div>
                            ))}
                                ...
                                <div className="all__sidebar-item-tag">
                                    <ul>
                                        {blogPost.map((data, id) => (
                                            <li key={id}><Link to={`/blog/${data.id}`}>{data.title.split(' ').slice(0, 1).join(' ')}</Link></li>
                                        ))}
                                    </ul>
                                </div>
                            </div>
                            <div className="blog__details-area-author">
                                ...
                                <div className="blog__details-area-author-content">
                                    <h5>{singleData.author ? singleData.author.name : 'Author'}</h5>
                                    <p>{singleData.author ? singleData.author.role : ''}</p>
                            ...
                            <div className="blog__details-area-comment mt-40">
                                ...
                                <div className="blog__details-area-comment-item">
                                    <div className="blog__details-area-comment-item-comment">
                                        ...
                                        <div className="blog__details-area-comment-item-comment-content">
                                            <h5>Guy Hawkins<Link to="#"><i className="far fa-reply-all"></i>Reply</Link></h5>
                                ...
                                <div className="blog__details-area-comment-item ml-65 sm-ml-0">
                                    <div className="blog__details-area-comment-item-comment">
                                        <div className="blog__details-area-comment-item-comment-image">
                                            <img src={avatar3} alt="avatar-image" />
                                        </div>							
                                        <div className="blog__details-area-comment-item-comment-content">
                                            <h5>Kristin Watson<Link to="#"><i className="far fa-reply-all"></i>Reply</Link></h5>
