                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-5 lg-mb-25">
                        <div className="certification-left section-padding pb-0">
                            <span className="subtitle wow fadeInLeft" data-wow-delay=".4s">Proven Results</span>
                            <h2 className="title_split_anim">Performance That Wins Bids</h2>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="counter__one-area mt-80">
                                ...
                                <h2><Count number={12345}/>+</h2>
                                <p>Completed Estimates</p>
                            </div>
                            <div className="certification-right-counter">
                                <h2><Count number={85}/>+</h2>
                                <p>Estimators & Analysts</p>
                            </div>
                            <div className="certification-right-counter">
                                <h2><Count number={1230}/>+</h2>
                                <p>Client Reviews</p>
                            </div>
                            <div className="certification-right-counter">
                                <h2><Count number={4560}/>+</h2>
                                <p>Winning Bids Supported</p>
                            </div>
                        </div>
                    </div>
                </div>
